...
def procesar_prorroga_por_licencia(sender, instance, created, **kwargs):
    ...
    if created and instance.objeto == "licencia_baja":
        ...
        alta_licencia_res = (
            Resolucion.objects.filter(cargo=cargo, objeto="licencia_alta")
            .order_by("-fecha_inicio_licencia")
            .first()
        )
        ...
        if (
            not alta_licencia_res.fecha_inicio_licencia
            or not instance.fecha_fin_licencia
        ):
            print(
        ...
        if alta_licencia_res.genera_prorroga_ca:
            ...
            duracion_licencia = (
                instance.fecha_fin_licencia - alta_licencia_res.fecha_inicio_licencia
            )
